...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  // Always initialize with "en" to match server render, then sync from localStorage
...
const translations = {
  en: {
    ...
    form: {
      ...
      clear: "Clear",
      evidenceLabel: "Supporting Documents / Evidence",
      evidenceDropzone: "Click to attach files (any format)",
      evidenceHint: "Photos, documents, screenshots, videos, etc.",
  ...
  te: {
    ...
    form: {
      ...
      clear: "క్లియర్",
      evidenceLabel: "సహాయక పత్రాలు / సాక్ష్యాలు",
      evidenceDropzone: "ఫైల్స్ జతచేయడానికి క్లిక్ చేయండి (ఏ ఫార్మాట్ అయినా)",
      evidenceHint: "ఫోటోలు, పత్రాలు, స్క్రీన్‌షాట్లు, వీడియోలు, మొదలైనవి.",
      evidenceCount: "ఫైల్స్ జతచేయబడ్డాయి",
    },
    analysis: {
      confidence: "నమ్మకం",
      high: "అధికం",
